...
namespace RedRunner.Characters
{
    public class RedCharacter : Character
    {
        ...
        [Header("Character Details")] [Space] [SerializeField]
        protected float m_MaxRunSpeed = 8f;

        [SerializeField] protected float m_RunSmoothTime = 5f;
        [SerializeField] protected float m_RunSpeed = 5f;
        [SerializeField] protected float m_WalkSpeed = 1.75f;
        [SerializeField] protected float m_JumpStrength = 10f;
        [SerializeField] protected string[] m_Actions = new string[0];
        [SerializeField] protected int m_CurrentActionIndex = 0;

        [Header("Character Reference")] [Space] [SerializeField]
        protected Rigidbody2D m_Rigidbody2D;

        [SerializeField] protected Collider2D m_Collider2D;
        [SerializeField] protected Animator m_Animator;
        [SerializeField] protected GroundCheck m_GroundCheck;
        [SerializeField] protected ParticleSystem m_RunParticleSystem;
        [SerializeField] protected ParticleSystem m_JumpParticleSystem;
        [SerializeField] protected ParticleSystem m_WaterParticleSystem;
        [SerializeField] protected ParticleSystem m_BloodParticleSystem;
        [SerializeField] protected Skeleton m_Skeleton;
        [SerializeField] protected float m_RollForce = 10f;

        [Header("Character Audio")] [Space] [SerializeField]
        protected AudioSource m_MainAudioSource;

        [SerializeField] protected AudioSource m_FootstepAudioSource;
        [SerializeField] protected AudioSource m_JumpAndGroundedAudioSource;
        ...
        public override float MaxRunSpeed => m_MaxRunSpeed;

        public override float RunSmoothTime => m_RunSmoothTime;

        public override float RunSpeed => m_RunSpeed;

        public override float WalkSpeed => m_WalkSpeed;

        public override float JumpStrength => m_JumpStrength;

        public override Vector2 Speed => m_Speed;

        public override string[] Actions => m_Actions;

        public override string CurrentAction => m_Actions[m_CurrentActionIndex];

        public override int CurrentActionIndex => m_CurrentActionIndex;

        public override GroundCheck GroundCheck => m_GroundCheck;

        public override Rigidbody2D Rigidbody2D => m_Rigidbody2D;

        public override Collider2D Collider2D => m_Collider2D;

        public override Animator Animator => m_Animator;

        public override ParticleSystem RunParticleSystem => m_RunParticleSystem;

        public override ParticleSystem JumpParticleSystem => m_JumpParticleSystem;

        public override ParticleSystem WaterParticleSystem => m_WaterParticleSystem;

        public override ParticleSystem BloodParticleSystem => m_BloodParticleSystem;

        public override Skeleton Skeleton => m_Skeleton;

        public override bool ClosingEye => m_ClosingEye;

        public override bool Guard => m_Guard;

        public override bool Block => m_Block;

        public override AudioSource Audio => m_MainAudioSource;
        ...
        void Update()
        {
            ...
            {
                m_CurrentRunSpeed =
                    Mathf.SmoothDamp(m_Speed.x, m_MaxRunSpeed, ref m_CurrentSmoothVelocity, m_RunSmoothTime);
            }
