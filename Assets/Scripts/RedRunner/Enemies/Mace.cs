...
namespace RedRunner.Enemies
{
    public class Mace : Enemy
    {
        ...
        [SerializeField] protected float m_MaulSpeed = 0.5f;
        [SerializeField] protected float m_MaulScale = 0.8f;
...
//			Camera.main.GetComponent<CameraControl> ().Shake (3f, 30, 300f);
        ...
        public virtual void Slam(Vector3 position)
        {
            ...
            ParticleSystem particle =
                Instantiate<ParticleSystem>(m_ParticleSystem, position, m_ParticleSystem.transform.rotation);
