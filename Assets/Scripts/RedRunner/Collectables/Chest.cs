...
namespace RedRunner.Collectables
{
    public class Chest : Collectable
    {
        ...
        [SerializeField] protected bool m_UseOnTriggerEnter2D = true;
        [SerializeField] protected int m_MinimumCoins = 5;
        [SerializeField] protected int m_MaximumCoins = 10;
        [SerializeField] protected CoinRigidbody2D m_CoinRigidbody2D;
        [SerializeField] protected Transform m_SpawnPoint;
        [SerializeField] protected ParticleSystem m_ParticleSystem;
        [SerializeField] [Range(-100f, 100f)] protected float m_RandomForceYMinimum = -10f;
        [SerializeField] [Range(-100f, 100f)] protected float m_RandomForceYMaximum = 10f;
        [SerializeField] [Range(-100f, 100f)] protected float m_RandomForceXMinimum = -10f;
        [SerializeField] [Range(-100f, 100f)] protected float m_RandomForceXMaximum = 10f;
        ...
        public override SpriteRenderer SpriteRenderer => m_SpriteRenderer;

        public override bool UseOnTriggerEnter2D
        {
            get => m_UseOnTriggerEnter2D;
            set => m_UseOnTriggerEnter2D = value;
        }

        public virtual int MinimumCoins => m_MinimumCoins;

        public virtual int MaximumCoins => m_MaximumCoins;

        public virtual CoinRigidbody2D CoinRigidbody2D => m_CoinRigidbody2D;

        public virtual Transform SpawnPoint => m_SpawnPoint;

        public virtual ParticleSystem ParticleSystem => m_ParticleSystem;

        public virtual float RandomForceYMinimum
        {
            get => m_RandomForceYMinimum;
            set => m_RandomForceYMinimum = value;
        }

        public virtual float RandomForceYMaximum
        {
            get => m_RandomForceYMaximum;
            set => m_RandomForceYMaximum = value;
        }

        public virtual float RandomForceXMinimum
        {
            get => m_RandomForceXMinimum;
            set => m_RandomForceXMinimum = value;
        }

        public virtual float RandomForceXMaximum
        {
            get => m_RandomForceXMaximum;
            set => m_RandomForceXMaximum = value;
        }
        ...
        public virtual void OnChestOpened()
        {
            ...
            {
                CoinRigidbody2D coin = Instantiate<CoinRigidbody2D>(m_CoinRigidbody2D, m_SpawnPoint.position,
