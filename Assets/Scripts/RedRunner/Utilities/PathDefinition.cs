...
namespace RedRunner.Utilities
{
    ...
    {
        [SerializeField] protected List<PathPoint> m_Points;
        [SerializeField] protected bool m_UseGlobalDelay = false;
        [SerializeField] protected float m_GlobalDelay = 0f;
        [SerializeField] protected bool m_ContinueToStart = false;

        protected int m_CurrentPointIndex = 0;

        public virtual List<PathPoint> Points => m_Points;

        public virtual bool UseGlobalDelay => m_UseGlobalDelay;

        public virtual float GlobalDelay => m_GlobalDelay;

        public virtual bool ContinueToStart => m_ContinueToStart;

        public virtual int CurrentPointIndex => m_CurrentPointIndex;
