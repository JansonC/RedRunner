...
namespace RedRunner.Utilities
{
    public class GroundCheck : MonoBehaviour
    {
        ...
        [SerializeField] private float m_RayDistance = 0.5f;
        ...
        void Update()
        {
            ...
            RaycastHit2D hit1 = Physics2D.Raycast(left, new Vector2(0f, -1f), m_RayDistance,
            ...
            RaycastHit2D hit2 = Physics2D.Raycast(center, new Vector2(0f, -1f), m_RayDistance,
                LayerMask.GetMask(GROUND_LAYER_NAME));
            ...
            RaycastHit2D hit3 = Physics2D.Raycast(right, new Vector2(0f, -1f), m_RayDistance,
                LayerMask.GetMask(GROUND_LAYER_NAME));
