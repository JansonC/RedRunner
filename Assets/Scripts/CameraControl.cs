...
public class CameraControl : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (IsMoving)
        {
            ...
            MainAxis.position =
                Vector3.MoveTowards(MainAxis.position, _newPosition, Time.deltaTime * _currentMoveSpeed);
        ...
        if (IsShaking)
        {
            ...
            ShakeAxis.localPosition =
                Vector3.MoveTowards(ShakeAxis.localPosition, _nextShakePosition, Time.deltaTime * _shakeSpeed);
    ...
    public void Move(float x, float y, float speed = 0)
    {
        ...
        _currentMoveSpeed = speed > 0 ? speed : MoveSpeed;
